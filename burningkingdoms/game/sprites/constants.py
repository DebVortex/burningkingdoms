...
WEAPON_OVERSIZE_BOTH_HANDS_SPEAR = 12
WEAPON_OVERSIZE_BOTH_HANDS_DRAGONSPEAR = 13
WEAPON_OVERSIZE_BOTH_HANDS_TRIDENT = 14
WEAPON_OVERSIZE_RIGHT_HAND_LONGSWORD = 15
WEAPON_OVERSIZE_RIGHT_HAND_MACE = 16
WEAPON_OVERSIZE_RIGHT_HAND_SABER = 17
WEAPON_OVERSIZE_RIGHT_HAND_RAPIR = 18

OVERSIZE_WEAPONS = [
    WEAPON_DEFAULT,
    WEAPON_OVERSIZE_BOTH_HANDS_SPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_DRAGONSPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_TRIDENT,
    WEAPON_OVERSIZE_RIGHT_HAND_LONGSWORD,
    WEAPON_OVERSIZE_RIGHT_HAND_MACE,
    WEAPON_OVERSIZE_RIGHT_HAND_SABER,
    WEAPON_OVERSIZE_RIGHT_HAND_RAPIR
]

BOTH_HANDS_WEAPONS = [
    WEAPON_DEFAULT,
    WEAPON_BOTH_HANDS_SPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_SPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_DRAGONSPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_TRIDENT
]
...
OFF_HAND_WEAPONS = [
    WEAPON_DEFAULT,
    WEAPON_LEFT_HAND_SHIELD_1,
    WEAPON_LEFT_HAND_SHIELD_2
]

MAIN_HAND_WEAPONS = [
    WEAPON_DEFAULT,
    WEAPON_BOTH_HANDS_SPEAR,
    WEAPON_RIGHT_HAND_BOW,
    WEAPON_RIGHT_HAND_SKELETON_BOW,
    WEAPON_RIGHT_HAND_DAGGER,
    WEAPON_RIGHT_HAND_GREATBOW,
    WEAPON_RIGHT_HAND_RECURVEBOW,
    WEAPON_RIGHT_HAND_WOODWAND,
    WEAPON_OVERSIZE_BOTH_HANDS_SPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_DRAGONSPEAR,
    WEAPON_OVERSIZE_BOTH_HANDS_TRIDENT,
    WEAPON_OVERSIZE_RIGHT_HAND_LONGSWORD,
